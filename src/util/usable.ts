                          ...
                          AND (
                            ...
                            OR (
                              jpg."job_auth_rank" = 4 AND NOT EXISTS (
                                ...
                                WHERE der2."documentId" = der."documentId" AND jpg2."job_auth_rank" = 2 AND der2.rode = false
                              )
                            )
                            OR (
                              jpg."job_auth_rank" = 6 AND NOT EXISTS (
                                ...
                                JOIN "JobPosition" AS jp2 ON e2."job_position_id" = jp2.id
                                JOIN "JobPositionGroup" AS jpg2 ON jp2."jobGroupId" = jpg2.id
                                WHERE der2."documentId" = der."documentId" AND jpg2."job_auth_rank" IN (2, 4) AND der2.rode = false
                              )
                            )
                          )
                        GROUP BY
